...
if("TRUE" STREQUAL "TRUE")
  set(alice_pointcloud_SOURCE_PREFIX /home/flimdejong/catkin_ws/src/alice_pointcloud)
  set(alice_pointcloud_DEVEL_PREFIX /home/flimdejong/catkin_ws/devel)
  ...
  set(alice_pointcloud_INSTALL_PREFIX /home/flimdejong/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'alice_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/flimdejong/catkin_ws/src/alice_pointcloud/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT alice_pointcloud_NUM_DUMMY_TARGETS)
      set(alice_pointcloud_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::alice_pointcloud::wrapped-linker-option${alice_pointcloud_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR alice_pointcloud_NUM_DUMMY_TARGETS "${alice_pointcloud_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::alice_pointcloud::wrapped-linker-option${alice_pointcloud_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND alice_pointcloud_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(alice_pointcloud_EXPORTED_TARGETS ${${alice_pointcloud_dep}_EXPORTED_TARGETS})
endforeach()
